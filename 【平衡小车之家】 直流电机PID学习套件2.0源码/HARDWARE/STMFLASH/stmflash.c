...
void Flash_Read(void)
{
	...
	if(PID_Parameter[0]==65535&&PID_Parameter[1]==65535&&PID_Parameter[2]==65535&&PID_Parameter[3]==65535&&PID_Parameter[4]==65535)   //Flash被清零之后，使用默认参数
	{
	Position_KP=120;   //默认参数
	Position_KI=0.1;
	Position_KD=500;
  Velocity_KP=20;
	Velocity_KI=30;
	...
	{		
	Position_KP=(float)PID_Parameter[0]/100;  //读取掉电保存的参数
	Position_KI=(float)PID_Parameter[1]/100;
	Position_KD=(float)PID_Parameter[2]/100;
	Velocity_KP=(float)PID_Parameter[3]/100;
	Velocity_KI=(float)PID_Parameter[4]/100;
	}
}	

void Flash_Write(void)
{
Flash_Parameter[0]=Position_KP*100;		   //向Flash里面写参数
Flash_Parameter[1]=Position_KI*100;	
Flash_Parameter[2]=Position_KD*100;	
Flash_Parameter[3]=Velocity_KP*100;	
Flash_Parameter[4]=Velocity_KI*100;
